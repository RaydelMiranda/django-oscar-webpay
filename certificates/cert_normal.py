...
class certDictionary():
    ...
    def dictionaryCert():
        ...
        certificate['private_key'] = oscar_webpay_settings.WEBPAY_NORMAL['PRIVATE_KEY']

        """ Certificado Publico: Configura tu ruta absoluta """
        certificate['public_cert'] = oscar_webpay_settings.WEBPAY_NORMAL['PUBLIC_CERT']

        """ Certificado Privado: COnfigura tu ruta absoluta """
        certificate['webpay_cert'] = oscar_webpay_settings.WEBPAY_NORMAL['WEBPAY_CERT']

        """ Codigo Comercio """
        certificate['commerce_code'] = oscar_webpay_settings.WEBPAY_NORMAL['COMMERCE_CODE']
